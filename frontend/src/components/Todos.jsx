      ...
      <h2>To-Dos</h2>
        {todos.map((todo) => ( 
          <div className="todo" key={todo._id}>  
            <DeleteForeverIcon className="todo-icon" onClick={() => handleDelete(todo)} style={{width: '18px'}}/>
            <AutoFixHighIcon className="todo-icon" onClick={() => handleUpdate(todo)} style={{width: '18px'}}/>
